local Translations = {
    ...
    command = {
		...
		dvall = { help = 'Deletar todos os veículos desocupados do mapa (Somente administrador)' },
        dvp = { help = 'Deletar os veículos desocupados próximos (Somente administrador)' },
        dvo = { help = 'Deletar o veículo que você está olhando diretamente (Somente administrador)' },
        givemoney = {
